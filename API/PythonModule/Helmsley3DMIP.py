...
class MLObject:
	...
	def __init__(self, path_to_dicom = "MRI_Images/", path_to_hdf5 = "unet_colon_25_new_2.hdf5", path_to_mask_output = "png_masks_output/"):
		self.input_folder_path = path_to_dicom
		self.hdf5_file_path = path_to_hdf5
		self.png_masks_folder = path_to_mask_output
	...
	def GetPredictedMasksFromDicom(self, path_to_dicom = "", path_to_hdf5 = "", path_to_output = "", verbose = 1):
		...
		comm = "rm -rf ./" + self.png_masks_folder
		os.system(comm)

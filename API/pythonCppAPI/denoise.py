...
def DenoiseImages(path_to_the_masks, output_path):
    original = getNumpyMasks(path_to_the_masks)
    ...
    save_img_from_np(a_filter * getNumpyMasks(path_to_the_masks), output_path)
    
    return a_filter * getNumpyMasks(path_to_the_masks)
